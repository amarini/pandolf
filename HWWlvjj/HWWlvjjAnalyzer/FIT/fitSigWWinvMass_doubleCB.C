...
vector<double> fitSigWWinvMass_doubleCB(int iSig=2, int fixVar=0) {
  ...
  double meanIV[8]={200.,300.,350.,400.,450.,500.,550.,600.};
  double sigmaIV[8]={1.43,8.445,15.39,29.42,47.01,67.52,93.15,123.0};
  double effWidth[8]={10.1,13.12,18.36,31.05,48.1,68.26,93.7,123.41};
  ...
  string plotName;
  string massName[8]={"200","300","350","400","450","500","550","600"};
  ...
  vector<double> param;
    param.push_back(70.6146-.697703*meanIV[iSig]+0.00212559*meanIV[iSig]*meanIV[iSig]-0.00000180624*meanIV[iSig]*meanIV[iSig]*meanIV[iSig]);  
    param.push_back(-5.967+0.05885*meanIV[iSig]-0.00006977*meanIV[iSig]*meanIV[iSig]);				    
    param.push_back(1.0);									    
    param.push_back(3.38183-0.00421732*meanIV[iSig]);							    
    param.push_back(1.0);									    
    param.push_back(-1.37066+0.0190719*meanIV[iSig]-0.0000250673*meanIV[iSig]*meanIV[iSig]);                             
  ...
  // ------------------- Crystal Ball -------------------------------
  RooRealVar CB_mean("CB_mean","param 1 of CB",param[0],0.,100.);
//CB_mean.setConstant(kTRUE);
  RooRealVar CB_sigma("CB_sigma","param 2 of CB",param[1],0.,100.);
